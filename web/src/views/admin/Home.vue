			...
			<el-col :span="4" class="userinfo">
				<el-dropdown trigger="hover">
					...
					<el-dropdown-menu slot="dropdown">
						<el-dropdown-item @click.native="changePassFormVisible=true">修改密码</el-dropdown-item>
	...
	export default {
		...
		data() {
			...
			return {
				...
				allMenuItems:[
					{ path:'/admin/index',name:'首页',iconCls: 'menu-icon fa fa-home fa-lg' },
					{ path:'/admin/account',name:'客户账号查看',iconCls: 'menu-icon fa fa-user fa-lg' , role:'ROLE_ACCOUNT'},
					{ path:'/admin/maintain',name:'维保管理员管理',iconCls: 'menu-icon fa fa-user fa-lg' , role:'ROLE_ACCOUNT'},
					{ path:'/admin/maintainSub',name:'维保人员查看',iconCls: 'menu-icon fa fa-user fa-lg' , role:'ROLE_ACCOUNT'},
					{ path:'/admin/device',name:'设备管理',iconCls: 'menu-icon fa fa-camera fa-lg' , role:'ROLE_DEVICE'},
					{ path:'/admin/sim',name:'卡管理',iconCls: 'menu-icon fa fa-signal fa-lg' , role:'ROLE_SIM'},
					{ path:'/admin/park',name:'园区管理',iconCls: 'menu-icon fa fa-building fa-lg' , role:'ROLE_BUILDING'},
					{ path:'/admin/building',name:'楼宇管理',iconCls: 'menu-icon fa fa-building fa-lg' , role:'ROLE_BUILDING'},
					{ path:'/admin/floor',name:'楼层管理',iconCls: 'menu-icon fa fa-building fa-lg' , role:'ROLE_BUILDING'},
					{ path:'/admin/alarm',name:'告警管理',iconCls: 'menu-icon fa fa-warning fa-lg' , role:'ROLE_ALARM'},
					{ path:'/admin/sysLog',name:'日志查看',iconCls: 'menu-icon fa fa-comments fa-lg', role:'ROLE_SYSLOG'},
					{ path:'/admin/sysParam',name:'配置管理',iconCls: 'menu-icon fa fa-cog fa-lg', role:'ROLE_SYSPARAM'},
					{ path:'/admin/sysUser',name:'管理员账号管理',iconCls: 'menu-icon fa fa-user-circle-o fa-lg', role:'ROLE_SYSUSER'},
				]
			}
		},
		...
		computed:{
			menuItems(){
				var sysUser = JSON.parse(util.getFromSession('sysUser'));
				var roles=sysUser.role ? sysUser.role.split(','):[];
			...
			changePass(){
				this.$confirm('确认修改密码吗?', '提示', {
                    ...
                    let param = { 
                     ...
                     post('sysUser/changePass',param).then(result=>{
                        this.$message({
							message: '密码修改成功',
							type: 'success'
						});
		...
		mounted() {
			var sysUser = util.getFromSession('sysUser');
			if (sysUser) {
				this.sysUser = JSON.parse(sysUser);
				this.fullName=this.sysUser.fullName;
			}
