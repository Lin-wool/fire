...
import com.bcloud.fire.entity.Device;
import com.bcloud.fire.repository.DeviceRepository;
...
public class DeviceController extends BaseController {
    ...
    public Resp list(final @RequestParam(defaultValue = "") String searchName,
        ...
        Page<Device> deviceList = deviceRepository.findAll(spec, pageRequest);
        return Resp.success(deviceList);
    }
    ...
    public Resp save(HttpServletRequest request,
        ...
        if (id != null) {
            model = deviceRepository.findOne(id);
            if (model == null) {
    ...
    public Resp delete(HttpServletRequest request, @RequestParam String ids) {
        ...
        if (StringUtils.isNotBlank(ids)) {
            ...
            for (String id : idArray) {
                deviceRepository.delete(Long.valueOf(id));
            }
