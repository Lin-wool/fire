...
import com.bcloud.fire.repository.DeviceTypeRepository;
...
public class DeviceTypeController extends BaseController {
    ...
    @Authority(role = "ROLE_DEVICETYPE")
    @RequestMapping(value = "/deviceType/list", method = { RequestMethod.POST })
    public Resp list(final @RequestParam(defaultValue = "") String searchName,
        ...
        Page<DeviceType> deviceTypeList = deviceTypeRepository.findAll(spec, pageRequest);
        return Resp.success(deviceTypeList);
    }

    @Authority(role = "ROLE_DEVICETYPE")
    @RequestMapping(value = "/deviceType/save", method = { RequestMethod.POST })
    public Resp save(HttpServletRequest request,
        ...
        DeviceType original = new DeviceType();
        if (id != null) {
            model = deviceTypeRepository.findOne(id);
            if (model == null) {
        ...
        deviceTypeRepository.save(model);
    ...
    public Resp delete(HttpServletRequest request, @RequestParam String ids) {
        ...
        if (StringUtils.isNotBlank(ids)) {
            ...
            for (String id : idArray) {
                deviceTypeRepository.delete(Long.valueOf(id));
            }
